test_that("readPanel works",{
  ...
  expect_equal(cur_test$Name, c("CD98", "NFKB", "FN1", "CD73", "beta.actin", "VIM", "Collagen.1A1",
  ...
  # since the example CSV uses pre-cleaned names, OriginalName == Name
  expect_equal(cur_test$OriginalName, cur_test$Name)
